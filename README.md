...
# アプリケーション概要
読書して面白かった本を紹介し、紹介を見て本を読んでくれた人と交流するアプリケーション。
...
# アプリケーションを作成した背景
本を読むことが好きな友人が、本を読んだ後にSNSで同じく読んだ人が居ないか探したり、この本を読んで欲しいと知り合いに勧めていた。
知り合いから直接勧められるのであれば興味を持ちやすく、勧められた人は本を読む。そして、読了時には勧めてくれた相手に読んだ事を伝えるが、通常のSNS上ではネタバレのある内容の話を行いにくい。よって、友人間で本を勧め、その感想を言い合うことが円滑にできるSNSがあれば、新しい人の手に本が渡りやすくなり、本好きの人の交流に役立つのではないかと思い、作成した。
...
投稿ページ：画像、タイトル、出版社、ジャンル、詳細、おすすめポイント、参考の本の情報を入力可能
...
詳細詳細ページ：紹介のさらに下に感想コメントフォームがあり、コメントを投稿できる
...
他人の投稿した紹介ページでは、コメント欄が表示されず、「読んだ？」のボタンを押す事で非同期更新によりフォームが表示され、読んだ人数カウントが進む。

現在、非同期更新でフォーム表示されたままではフォーム投稿ができない不具合がある。ページリロードで投稿可能。
